...
export default function ProductionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!isOperatingHours) {
      setError('Akses laporan produksi hanya dapat diisi pada jam operasional 05:00 - 23:00 WIB.');
      return;
    }
    ...
    <div className="space-y-6 max-w-lg mx-auto">
      ...
      <div className="rounded-xl border border-amber-200 bg-amber-50/70 p-4 space-y-2 text-xs text-amber-900 shadow-2xs">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-amber-200/60">
          <span className="text-slate-600 font-medium">Jam Operasional Input: <strong>05:00 - 23:00 WIB</strong></span>
        ...
        <div className="rounded-2xl border-2 border-amber-300 bg-amber-50/90 p-5 text-amber-950 shadow-sm flex items-start gap-3.5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-amber-800 leading-relaxed">
              Penginputan laporan memasak teh hanya dapat dilakukan saat jam operasional <strong>05:00 WIB s/d 23:00 WIB</strong>.
            </p>
